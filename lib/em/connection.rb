module EventMachine
  ...
  class Connection
    ...
    #
    #
    # @option args [String] :ca_file (nil)  takes a String, which is interpreted as the name of a readable file in the
    ...
    #
    # @option args [String] :private_key_pwd (nil)  takes a String, which is interpreted as the password for the private_key_file
    ...
    #  module Handler
    #    def post_init
    #      start_tls(:ca_file => '/tmp/ca.crt', :private_key_file => '/tmp/server.key', :private_key_pwd => 'password', :cert_chain_file => '/tmp/server.crt', :verify_peer => false)
    #    end
    #  end
    #
    #   EventMachine.run do
