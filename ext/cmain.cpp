...
/******************
evma_set_tls_parms
+  * [TD] Added ca_filename - an optional certificate authority file provided to SSL_CTX_load_verify_locations for client-side server certificate verification using this list of known trusted CAs
+  * [TD] Added privatekey_pwd - an optional password used to decrypt the privatekey_filename
******************/
